    ...
    extend: {
      ...
      colors: {
        ...
        industry: {
          ...
          hr: "hsl(var(--industry-hr))",
          manufacturing: "hsl(var(--industry-manufacturing))",
          retail: "hsl(var(--industry-retail))",
          healthcare: "hsl(var(--industry-healthcare))",
          finance: "hsl(var(--industry-finance))",
          marketing: "hsl(var(--industry-marketing))",
          it: "hsl(var(--industry-it))",
          sustainability: "hsl(var(--industry-sustainability))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
