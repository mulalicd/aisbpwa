...
export default function PromptExecutionPage() {
  ...
  const handleDownloadPDF = async () => {
    ...
    const title = document.title || "AI Solved Business Problems";
    ...
    // FIX: position:fixed keeps element in render tree — html2canvas captures it correctly.
    // position:absolute left:-9999px is outside viewport box and produces blank canvas.
